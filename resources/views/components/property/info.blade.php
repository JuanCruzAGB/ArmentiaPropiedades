...
@endif
    <a href="/propiedad/propiedad-1/detalles" class="card-body row p-0">
        <figure class="card-image col-12 mb-0 p-0">
            <img src="{{asset('storage/property/1/01.jpg')}}" alt="Property image">
        </figure>
...
@if(Route::current()->getName() === 'property.list')
    ...
    <li class="property card col-11 col-md-5 col-xl-3 col-md-3">
        <a href="/propiedad/propiedad-1/detalles" class="card-body row p-0">
            ...
            <header class="card-title col-12 m-0 p-0">
                <h3 class="h6 text-center mb-0 p-3">Propiedad 9</h3>
            </header>
            <div class="card-icon col-12">
                <i class="icon fas fa-sign-in-alt"></i>
            </div>
    ...
    <li class="property card col-11 col-md-5 col-xl-3 col-md-3">
        <a href="/propiedad/propiedad-1/detalles" class="card-body row p-0">
            ...
            <header class="card-title col-12 m-0 p-0">
                <h3 class="h6 text-center mb-0 p-3">Propiedad 10</h3>
            </header>
            <div class="card-icon col-12">
                <i class="icon fas fa-sign-in-alt"></i>
            </div>
    ...
    <li class="property card col-11 col-md-5 col-xl-3 col-md-3">
        <a href="/propiedad/propiedad-1/detalles" class="card-body row p-0">
            ...
            <header class="card-title col-12 m-0 p-0">
                <h3 class="h6 text-center mb-0 p-3">Propiedad 11</h3>
            </header>
            <div class="card-icon col-12">
                <i class="icon fas fa-sign-in-alt"></i>
            </div>
    ...
    <li class="property card col-11 col-md-5 col-xl-3 col-md-3">
        <a href="/propiedad/propiedad-1/detalles" class="card-body row p-0">
            ...
            <header class="card-title col-12 m-0 p-0">
                <h3 class="h6 text-center mb-0 p-3">Propiedad 12</h3>
            </header>
            <div class="card-icon col-12">
                <i class="icon fas fa-sign-in-alt"></i>
            </div>
