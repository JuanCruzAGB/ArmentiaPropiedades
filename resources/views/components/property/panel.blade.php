            ...
            <table class="table">
                <thead>
                    <tr class="background background-uno color-tres">
                        ...
                        <th scope="col" class="Work-Sans h4">Categoría</th>
                        <th scope="col" class="Work-Sans h4">Ubicación</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="actions px-0">
                            <a href="#" class="btn btn-uno-transparent btn-icon mr-1" title="Ver más">
