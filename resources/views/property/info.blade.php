                        ...
                        <div class="row justify-content-between px-3 pr-md-0">
                            <div class="files p-0">
                                @foreach ($property->files as $key => $image)
                                    ...
                                    @endif
                                        <img class="gallery-image m-0" src="{{ asset("storage/$image") }}" alt="{{ $property->name }} - Image {{ $key }}">
                                    </a>
                                @endforeach
                            </div>
                            <a target="_blank" href="{{ asset('storage/property/1/01.jpg') }}" class="selected overflow-hidden p-0">
                                <figure class="m-0">
                                    <img class="gallery-image zoom" src="{{ asset('storage/property/1/01.jpg') }}" alt="{{ $property->name }} - Image selected">
